...
namespace OpenTissue
{
  namespace glut
  {
    ...
    protected:
      ...
      OpenTissue::gl::Frustum<math_types>	  m_frustum;           ///< Frustum class, can be used for optimizing the rendering process by offering simple frustum culling.
    ...
    public:
      ...
      OpenTissue::gl::Frustum<math_types> const & frustum()          const { return m_frustum; }
      OpenTissue::gl::Frustum<math_types>       & frustum()                { return m_frustum; }
